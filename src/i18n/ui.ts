...
export const ui = {
  en: {
    ...
    'booking.phone': 'Phone',
    'booking.phone.placeholder': 'e.g. +506 8888 8888',
  ...
  es: {
    ...
    'philosophy.priscila.name': 'Priscila Solera Castañeda',
    'philosophy.priscila.bio': 'Priscila es cosmetóloga profesional, terapeuta holística y maquillista certificada, además de fundadora y operadora de Blue Royale. Con más de diez años en la industria de la belleza y el spa, ha convertido su vocación en su pasión. Está comprometida con superar las expectativas de cada huésped y con ofrecer experiencias memorables en su Costa Rica natal.',
    ...
    'booking.phone.placeholder': 'Ej. +506 8888 8888',
